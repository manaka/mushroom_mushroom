class CreateMushrooms < ActiveRecord::Migration[6.1]
  def change
    create_table :mushrooms do |t|
      ...
      t.integer :cap_color_id, null: false, foreign_key: true
      t.boolean :bruises
      ...
      t.integer :gill_color_id, null: false, foreign_key: true
      t.references :stalk_shape, null: false, foreign_key: true
      t.references :stalk_root, null: false, foreign_key: true
      t.integer :stalk_surface_above_ring_id, null: false, foreign_key: true
      t.integer :stalk_surface_below_ring_id, null: false, foreign_key: true
      t.integer :stalk_color_above_ring_id, null: false, foreign_key: true
      t.integer :stalk_color_below_ring_id, null: false, foreign_key: true
      t.references :veil_type, null: false, foreign_key: true
      t.integer :veil_color_id, null: false, foreign_key: true
      t.references :ring_number, null: false, foreign_key: true
      t.references :ring_type, null: false, foreign_key: true
      t.integer :spore_print_color_id, null: false, foreign_key: true
