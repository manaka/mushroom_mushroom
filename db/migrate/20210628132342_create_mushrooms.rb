class CreateMushrooms < ActiveRecord::Migration[6.1]
  def change
    create_table :mushrooms do |t|
      ...
      t.references :cap_color, null: false, foreign_key: true
      t.boolean :bruises
      ...
      t.references :gill_color, null: false, foreign_key: true
      t.references :stalk_shape, null: false, foreign_key: true
      t.references :stalk_root, null: false, foreign_key: true
      t.references :stalk_surface_above_ring, null: false, foreign_key: true
      t.references :stalk_surface_below_ring, null: false, foreign_key: true
      t.references :stalk_color_above_ring, null: false, foreign_key: true
      t.references :stalk_color_below_ring, null: false, foreign_key: true
      t.references :veil_type, null: false, foreign_key: true
      t.references :veil_color, null: false, foreign_key: true
      t.references :ring_number, null: false, foreign_key: true
      t.references :ring_type, null: false, foreign_key: true
      t.references :spore_print_color, null: false, foreign_key: true
